...
var FormikContext = /*#__PURE__*/useContextSelector.createContext(undefined);
var FormikProvider = FormikContext.Provider;
function useFormikContext() {
  return useContextSelector.useContext(FormikContext);
}
function FormikConsumer(_ref) {
  ...
  return React.createElement(React.Fragment, null, children(formik));
}
function useFormikContextSelector(selector) {
  return useContextSelector.useContextSelector(FormikContext, selector);
}
...
function useField(nameOrOptions) {
  ...
  React.useEffect(function () {
    ...
    !registerField ?  invariant(false, 'useField() / <Field /> must be used underneath a <Formik> component or withFormik() higher order component')  : void 0;
...
function useFieldValue(name) {
  ...
  var setState = React.useCallback(function (value, shouldValidate) {
...
function useFieldError(name) {
  ...
  var setState = React.useCallback(function (error) {
    set(name, error);
  }, [name]);
  return [state, setState];
}
...
function useFieldTouched(name) {
  ...
  var setState = React.useCallback(function (isTouched, shouldValidate) {
...
function Field(_ref) {
  ...
  React.useEffect(function () {
    !!render ?  invariant(false, "<Field render> has been deprecated. Please use a child callback function instead: <Field name={" + name + "}>{props => ...}</Field> instead.")  : void 0;
    !!(component && render) ?  invariant(false, 'You should not use <Field component> and <Field render> in the same <Field> component; <Field component> will be ignored')  : void 0;
    ...
    !!(render && children && !isEmptyChildren(children)) ?  invariant(false, 'You should not use <Field render> and <Field children> in the same <Field> component; <FastField children> will be ignored')  : void 0; // eslint-disable-next-line
  }, []);
  ...
  return React.createElement(asElement, _extends({}, field, rest), children);
}
...
var Form = /*#__PURE__*/React.forwardRef(function Form(props, ref) {
  ...
  var handleReset = useContextSelector.useContextSelector(FormikContext, function (ctx) {
    return ctx.handleReset;
  });
  var handleSubmit = useContextSelector.useContextSelector(FormikContext, function (ctx) {
...
function connect(Comp) {
  var C = function C(props) {
    return React.createElement(FormikConsumer, {
...
function FastField(_ref) {
  ...
  React.useEffect(function () {
    ...
    !!shouldUpdate ?  invariant(false, "<FastField shouldUpdate> has been deprecated. Please create a custom component with useField and React.memo() instead.")  : void 0; // eslint-disable-next-line
  }, []);
...
exports.defaultFormatFn = defaultFormatFn;
exports.defaultParseFn = defaultParseFn;
exports.getActiveElement = getActiveElement;
exports.getIn = getIn;
exports.getSelectedValues = getSelectedValues;
exports.getValueForCheckbox = getValueForCheckbox;
...
exports.move = move;
exports.numberParseFn = numberParseFn;
...
exports.useFieldInitialError = useFieldInitialError;
exports.useFieldInitialTouched = useFieldInitialTouched;
exports.useFieldInitialValue = useFieldInitialValue;
...
exports.useFormikContextSelector = useFormikContextSelector;
exports.useInitialErrors = useInitialErrors;
exports.useInitialStatus = useInitialStatus;
exports.useInitialTouched = useInitialTouched;
exports.useInitialValues = useInitialValues;
